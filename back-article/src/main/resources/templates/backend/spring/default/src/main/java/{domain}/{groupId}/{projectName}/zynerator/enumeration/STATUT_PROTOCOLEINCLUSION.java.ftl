package ${config.domain}.${config.groupId}.${config.projectName}.zynerator.enumeration;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonFormat;
import com.fasterxml.jackson.annotation.JsonProperty;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.bean.BaseEnum;
