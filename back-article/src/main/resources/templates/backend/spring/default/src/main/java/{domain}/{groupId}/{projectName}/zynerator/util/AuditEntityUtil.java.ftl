...
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.audit.AuditEntity;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.dto.BaseDto;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.enumeration.ACTION_TYPE;
