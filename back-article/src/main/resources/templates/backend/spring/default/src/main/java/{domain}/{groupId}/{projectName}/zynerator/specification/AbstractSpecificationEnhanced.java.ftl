package ${config.domain}.${config.groupId}.${config.projectName}.zynerator.specification;


import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.audit.AuditBusinessObjectEnhanced;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.criteria.BaseCriteriaEnhanced;
