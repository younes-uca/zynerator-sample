...
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.exception.EntityNotFoundException;
...
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.specification.AbstractSpecification;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.util.FileUtils;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.util.ListUtil;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.util.MD5Checksum;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.util.RefelexivityUtil;
...
<#noparse>@Value("${uploads.location.directory}")</#noparse>
    private String UPLOADED_FOLDER;
<#noparse>@Value("${uploads.location.temp}")</#noparse>
