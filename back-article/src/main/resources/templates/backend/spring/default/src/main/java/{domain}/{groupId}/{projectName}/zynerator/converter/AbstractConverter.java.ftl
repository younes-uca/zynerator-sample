...
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.${config.bean}.Etablissement;
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.${config.dto}.EtablissementDto;
...
import ${config.domain}.${config.groupId}.${config.projectName}.zynerator.util.Utils;
